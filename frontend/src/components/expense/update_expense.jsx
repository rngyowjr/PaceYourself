    ...
    return (
      <div className="update-content">
        <form className="update-form" onSubmit={this.handleSubmit}>
          <div className="update-input-center">
            <div className="update-input-container">
              <label>Month:
                <select className="input-size" onChange={this.update("month")} defaultValue={expenses[idx].month}>
              ...
              <label>Year:
                <input
                  className="update-year-input input-size"
                  type="number"
                  min="2019" 
                  max="2025"
              ...
              <label>Expense: $
                <input
                  className="update-value-input input-size"
                  type="number"
                  min="0.01"
                  step="0.01"
